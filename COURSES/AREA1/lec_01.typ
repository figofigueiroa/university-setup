//lecture{1}{do 19 sep 2024 09:41}{TESTE 1}
#import "../template.typ": *


teste 1
= Introduction
Can you then _suppose_ that those heroic men performed their famous deeds *without any motive at all*? In a free hour, when our power of choice is untrammeled and when nothing prevents our being able to do what we like best, _*every pleasure is to be welcomed and for every pain avoided*_ .
