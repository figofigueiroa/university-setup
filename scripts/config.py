...
CURRENT_COURSE_SYMLINK = Path('~/projects/university-setup/selecionado/').expanduser()
CURRENT_COURSE_ROOT = CURRENT_COURSE_SYMLINK.resolve()
CURRENT_COURSE_WATCH_FILE = Path('/tmp/selecionado').resolve()
ROOT = Path('~/projects/university-setup/COURSES/').expanduser()
